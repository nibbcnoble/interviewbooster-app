...
export function buildInitialLog(
...
// Owns all terminal-shell state (log, input, busy, command history, module
// dispatch). This used to live in App.tsx, but since the terminal is only
// ever shown on this one tab, it makes more sense scoped here.
export default function InterviewPage({ onLogout }: InterviewPageProps) {
